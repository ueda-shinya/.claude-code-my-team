...
| 事業 | ディレクトリ | 案件 | 状況 |
|---|---|---|---|
| 明浄（or.jpサイト） | [biz-meijo/](biz-meijo/) | サーバー・ドメイン移行（4月中） | 進行中（期限あり） |
| 奈良トランスポート | [biz-nara-transport/](biz-nara-transport/) | `/hello-india` PDF配布ページ | 🔥 最優先（4/26インド商談） |
| 観光協会 | [biz-kanko-kyokai/](biz-kanko-kyokai/) | 検索・カテゴリ改修／ニュース一覧／ソーシャルウォール | 進行中 |

## 主な連絡手段
- **Chatwork**: わたなべ様とのやり取りで使用（or.jpドメインの共有等）
- **ギガファイル便**: 大容量バックアップ共有に使用実績あり
