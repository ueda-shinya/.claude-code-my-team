...
<main id="wrapper">
	<header>
		<a href="https://liff-gateway.lineml.jp/landing?follow=%40287urqgo&lp=r2Uvy5&liff_id=2000435990-JaVwxxnq" class="btn">
			<img src="images/btn_cv_bwj.png" width="750" alt=""/>
		</a>
	</header>
	<section>
		<div class="scrFadeTop">
			<p><img src="images/cont01_01.jpg" width="750" alt=""/></p>
			<p><img src="images/cont01_02.jpg" width="750" alt=""/></p>
			<h1><img src="images/cont01_03.jpg" width="750" alt=""/></h1>
			<p class="cv">
				<img src="images/cont01_04.jpg" width="750" alt=""/>
				<a class="btn cv_btn __bwj" href="https://liff-gateway.lineml.jp/landing?follow=%40287urqgo&lp=r2Uvy5&liff_id=2000435990-JaVwxxnq">
					<img src="images/btn_cv_bwj.png" alt="">
				</a>
			</p>
			<p><img src="images/cont01_05.jpg" width="750" alt=""/></p>
			<p><img src="images/cont01_06.jpg" width="750" alt=""/></p>
			<p><img src="images/cont01_07.jpg" width="750" alt=""/></p>
			<p class="mov mov__cont01_08">
				<img src="images/cont01_08.jpg" width="750" alt=""/>
				<span class="mov-wrap">
					<video autoplay loop muted playsinline preload="auto" >
						<source src="mov/bwj_movie.mp4" type="video/mp4" />
					</video>
				</span>
			</p>
			<p><img src="images/cont01_09.jpg" width="750" alt=""/></p>
		...
		<div class="scrFadeTop">
		<h2><img src="images/cont02_01.jpg" width="750" alt=""/></h2>
		...
		<div class="scrFadeTop">
			...
			<p class="cv">
				<img src="images/cont07_08_bwj.jpg" width="750" alt=""/>
				<a class="btn cv_btn __bwj" href="https://liff-gateway.lineml.jp/landing?follow=%40287urqgo&lp=r2Uvy5&liff_id=2000435990-JaVwxxnq">
					<img src="images/btn_cv_bwj.png" alt="">
				</a>
			</p>
		...
		<div class="cotactform-wrap spacer scrFadeTop">
		</div>
...
(function ($) {
	...
	<script>
		function initValidate() {
			0 < $("https://liff-gateway.lineml.jp/landing?follow=%40287urqgo&lp=r2Uvy5&liff_id=2000435990-JaVwxxnq").length && $("https://liff-gateway.lineml.jp/landing?follow=%40287urqgo&lp=r2Uvy5&liff_id=2000435990-JaVwxxnq").validationEngine({
