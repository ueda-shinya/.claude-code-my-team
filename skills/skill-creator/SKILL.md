...
3. Write to a temp file and open it:
   - Mac/Linux: `/tmp/eval_review_<skill-name>.html` → `open /tmp/eval_review_<skill-name>.html`
   - Windows: `$env:TEMP\eval_review_<skill-name>.html` → `start $env:TEMP\eval_review_<skill-name>.html`
